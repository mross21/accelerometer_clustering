...
import math
from config import PATH_ACCELEROMETER_PARQUET, PATH_OUTPUT_DATA
...
def main():
    ...
    for file in all_files:
        ...
        for userAndWk, group in dfByUser:
            ...
            dfOut = pd.concat([dfOut, dfDensities], ignore_index=True)

    dfOut.to_parquet(out_path(PATH_OUTPUT_DATA, 'equidistantPts_with_vMFdensities.parquet'), index=False)
    print('finish')
