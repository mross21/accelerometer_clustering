...
for file in all_files:
    ...
    for userAndGrp, group in dfByUser:
        ...
        print('equiPts density')
        group['cluster'] = np.where(group['density'] >= 0.2, group['neighborIdx']+1, 0)
    ...
    dfOut.to_csv(pathOut + 'user_' + str(userAndGrp[0]) + '_accelData_clusters_v2.csv', index=False)
